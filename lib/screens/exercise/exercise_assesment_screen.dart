...
class TakeAssesment extends StatefulWidget {
  const TakeAssesment({super.key});

  @override
  State<TakeAssesment> createState() => _TakeAssesmentState();
}
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        ...
                                                        //     "1. Let’s be the questions for now, Let’s        Let’s be the questions for now, Let’s ",
                                                        maxLines: 2,
                                                        style: GoogleFonts
                                                            .gothicA1(
                                                                fontSize: 13.sp,
                                                            ...
                                                            itemBuilder:
                                                              ...
                                                              return ListTile(
                                                                  ...
                                                                  title: Text(
                                                                      // assignmetData["exercise_questions"]
                                                                      //  "Test Course_101",
                                                                      assignmetData["exercise_questions"][index]["exercise_question_options"]
                                                                              [i][
                                                                          "title"],
                                                                      //maxLines: 2,
                                                                      style: GoogleFonts.gothicA1(
                                                                          fontSize: userChecked.contains(assignmetData["exercise_questions"][index]["exercise_question_options"][i]["title"])
                                                                              ? 15
                                                                                  .sp
                                                                              : 13
                                                                                  .sp,
                                                                          color: userChecked.contains(assignmetData["exercise_questions"][index]["exercise_question_options"][i]["title"])
                                                                              ? Gold
                                                                              : white,
                                                                          fontWeight:
                                                                              kFW700)),
                                                                  leading:
                                                                    ...
                                                                    activeColor: isSubmit ==
                                                                        ...
                                                                        ? grey
                                                                        : white,
                                                                    value: userChecked.contains(assignmetData["exercise_questions"][index]
                                                                            [
                                                                    ...
                                                                    onChanged:
                                                                      ...
                                                                      if (!isSubmit) {
                                                                        _onSelected(
                                                                            val!,
                                                                            assignmetData["exercise_questions"][index]["exercise_question_options"][i]["title"]);
                                                                        if (val ==
                                                                            true) {
                                                                          assignmetData["exercise_questions"][index]["exercise_question_options"][i]["is_answer"] == "false"
                                                                              ? _howmanyCorrect(false, assignmetData["exercise_questions"].length)
                                                                              : _howmanyCorrect(true, assignmetData["exercise_questions"].length);
                                                                        } else {
                                                                          _howmanyCorrect(
                                                                              false,
                                                                              assignmetData["exercise_questions"].length);
                                                                        }
                                                                      }
                                                                    },
                                                                  )
