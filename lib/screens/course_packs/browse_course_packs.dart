...
class CoursePacksView extends StatefulWidget {
  const CoursePacksView({super.key});

  @override
  State<CoursePacksView> createState() => _CoursePacksViewState();
}

class _CoursePacksViewState extends State<CoursePacksView> {
  bool isLoading = false;
  List favouritedCoursePacksdata = [];
  List<int> wishlisted = <int>[];
  var profiletopacksData = Get.arguments;
  Map GetFavouratedata = {};
  Future coursepackswhishlistedDataHandler() async {
    setState(() {
      isLoading = true;
    });
    Map payload = {
    ...
    if (value["data"] == null) {
      ...
      favouritedCoursePacksdata = value["data"];
    }
    print(value["data"]);
    setState(() {
      isLoading = false;
...
// List<int> wishlisted = <int>[];
  var profileIdData = Get.arguments;
  Future coursepacksHandler() async {
    ...
    Map payload = {
      ...
      //  "candidate_id": "502",
      "candidate_id":
          profileIdData["candidates"]["CandidateDetails"]["id"].toString(),
    };
    /////////////////////////////
  ...
  void initState() {
    super.initState();
    coursepacksHandler();
    coursepackswhishlistedDataHandler();
  }
                                                          ...
                                                          ? Row(
                                                              mainAxisAlignment:
                                                                  MainAxisAlignment
                                                                      .spaceBetween,
                                                              children: [
                                                                browseCoursePacks[index]["courses"][0]["skill_masters"]
                                                                            .length >=
                                                                        3
                                                                    ? Container(
                                                                        alignment:
