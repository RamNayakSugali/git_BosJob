...
class FavouriteCourses extends StatefulWidget {
  const FavouriteCourses({super.key});

  @override
  State<FavouriteCourses> createState() => _FavouriteCoursesState();
}

class _FavouriteCoursesState extends State<FavouriteCourses> {
  ...
  Map courseswished = {};
  // bool isLoading = false;
  Future favouritedcoursewishlistHandler(int id) async {
    setState(() {
      isLoading = true;
    });
...
//  bool isLoading = false;
  ...
  Future searchcourseHandler() async {
    ...
    if (value["data"] == null) {
      ...
      originalfavouritedCourse = value["data"];
    }
    print(value["data"]);
    setState(() {
      isLoading = false;
      ...
      child: Column(
        ...
        children: [
          TextFormField(
            ...
            onChanged: (value) {
              setState(() {
                favouritedCourse = originalfavouritedCourse
                    .where((element) => element["title"].contains(value))
                    .toList();
                debugPrint("${favouritedCourse.length}");
              });
            },
          ),
          //  Search(),
          ...
          isLoading == true
              ...
              : ListView.builder(
                  itemCount: favouritedCourse.length,
                  shrinkWrap: true,
                        ...
                        GestureDetector(
                          onTap: () {
                            Get.toNamed(
                              KProductionScreen,
                              // KAuthorProfile,
                              arguments: favouritedCourse[index]["id"] ?? "",
                            );
                          },
                                              ...
                                              Positioned(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    GestureDetector(
                                                      onTap: () {
                                                        favouritedcoursewishlistHandler(
                                                            favouritedCourse[
                                                                index]["id"]);
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  Text(
                                                    ...
                                                    //   )}',
                                                    "₹ ${moneyFormat(favouritedCourse[index]["price"].toString())}",
                                                    //  '\u{20B9}${699}',
                                                    style: GoogleFonts.gothicA1(
                                                        fontSize: kFourteenFont,
                                                        color: Gold,
                                              ...
                                              Text(
                                                favouritedCourse[index][
                                                        ...
                                                        0
                                                    ? "0/5"
                                                    : "${favouritedCourse[index]["course_reviews"][0]["rating"].toString()} /5",
